      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 text-primary-100">
            Browse tabletop products and request sample products shipped to your organization
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg p-6 shadow-lg">
            ...
            <p className="text-gray-600">
              Browse available tabletop games and request sample products to be shipped to your organization.
            </p>
          </div>
          <div className="bg-white rounded-lg p-6 shadow-lg">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">For Publishers</h3>
            <p className="text-gray-600">
              Create an account and list your products to provide sample products to non-profits and educational institutions.
            </p>
          </div>
          <div className="bg-white rounded-lg p-6 shadow-lg">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">Simple Process</h3>
            <p className="text-gray-600">
              No login required for requestors. Just browse products, fill out a form, and receive your sample product.
            </p>
          </div>
        </div>
      </div>
